execute as @e[tag=Overseer,limit=1] store result score @s item_count run data get block -396 76 -65 Items[{id:"minecraft:light_blue_concrete_powder"}].Count
scoreboard players set @e[tag=Overseer] multiplier 8
...
loot insert -407 76 -54 mine -396 76 -65 minecraft:air{drop_contents:1b}
data remove block -396 76 -65 Items[{id:"minecraft:light_blue_concrete_powder"}]