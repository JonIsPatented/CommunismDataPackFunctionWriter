execute as @e[tag=Overseer,limit=1] store result score @s item_count run data get block -396 76 -65 Items[{id:"minecraft:dark_oak_planks"}].Count
scoreboard players set @e[tag=Overseer] multiplier 1
...
loot insert -385 76 -58 mine -396 76 -65 minecraft:air{drop_contents:1b}
data remove block -396 76 -65 Items[{id:"minecraft:dark_oak_planks"}]