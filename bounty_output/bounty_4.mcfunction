execute as @e[tag=Overseer,limit=1] store result score @s item_count run data get block -396 76 -65 Items[{id:"minecraft:raw_iron_block"}].Count
scoreboard players set @e[tag=Overseer] multiplier 198
...
loot insert -407 76 -51 mine -396 76 -65 minecraft:air{drop_contents:1b}
data remove block -396 76 -65 Items[{id:"minecraft:raw_iron_block"}]