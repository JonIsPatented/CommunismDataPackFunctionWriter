execute as @e[tag=Overseer,limit=1] store result score @s item_count run data get block -396 76 -65 Items[{id:"minecraft:lapis_lazuli"}].Count
scoreboard players set @e[tag=Overseer] multiplier 5
...
loot insert -399 76 -35 mine -396 76 -65 minecraft:air{drop_contents:1b}
data remove block -396 76 -65 Items[{id:"minecraft:lapis_lazuli"}]