execute as @e[tag=Overseer,limit=1] store result score @s item_count run data get block -396 76 -65 Items[{id:"minecraft:yellow_concrete_powder"}].Count
...
data remove block -396 76 -65 Items[{id:"minecraft:yellow_concrete_powder"}]